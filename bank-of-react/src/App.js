...
class App extends Component {
  ...
  addCredit = (newCredit) => {
    ...
    this.setState({accountBalance: this.state.accountBalance + parseFloat(newCredit.amount)});
  }
  componentDidMount() {
  ...
  render() {
    ...
    const CreditsComponent = () => (<CreditsPage credits={this.state.credits} handleNewCredit={this.addCredit} balance={this.state.accountBalance} />)
